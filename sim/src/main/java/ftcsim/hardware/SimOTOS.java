...
public class SimOTOS extends SparkFunOTOS implements SimDevice {
    ...
    @Override public synchronized void resetTracking() { Pose2 sp = sensorPose(); originX = sp.x; originY = sp.y; originH = sp.heading; }
    ...
    @Override public Pose2D getPosition() { return relative(sensorPose()); }
    @Override public synchronized void setPosition(Pose2D pose) {
